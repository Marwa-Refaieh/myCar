...
const OurServicesCard = ({ number, title, question, text , soon}) => {
    return (
     ...
     border-MyOption border-2 rounded-lg overflow-hidden">
            ...
            <div className="relative text-white text-[1.5rem] md:text-[2rem] font-bold uppercase ml-4 pl-2 before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-[2px] before:h-5 before:bg-yellow-400">
                {number}
            </div>
